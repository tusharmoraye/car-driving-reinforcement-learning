...
while (count>0):
    ...
    while True: # the game loop
        ...
        if baddieAddCounter == ADDNEWBADDIERATE:
            ...
            if arrInd >= arrLen:
                arrInd = 0
            newBaddie = {'rect': pygame.Rect(arraySave[arrInd][0][0], arraySave[arrInd][0][1], 23, 47),
                        'speed': random.randint(BADDIEMINSPEED, BADDIEMAXSPEED),
                        #'surface':pygame.transform.scale(random.choice(sample), (23, 47)),
                        'surface':pygame.transform.scale(sample[arraySave[arrInd][1]], (23, 47)),                        
                        }
            #arraySave.append
    ...
    if (count==0):
     laugh.play()
     #np.save('coordinates.npy', arraySave)
